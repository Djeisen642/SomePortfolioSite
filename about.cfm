<cfscript>
	personalInfo = {name='Jason Suttles', dob='some date', address='123 A Street', phonenumber='(919) 555- 3228', email='jasonssuttles@gmail.com', website='http://www.simonfree.com', skype='mySkypeName'};
</cfscript>
			...
			<div class="clr">
				<div class="left">
					<div id="SliderBackground">
						<div id="Slider" align="center" >
							<img src="assets/images/headshot/headshot.png" alt="photo" height='220' width='220'/>
						</div><!-- #Slider -->
				...
				<div class="content">
					...
					<ul class="no-list social-list">
						<li class="social-list-twitter"> <span>Twitter Profile</span> <a href="http://twitter.com/JSSuttles">http://twitter.com/JSSuttles</a> </li>
